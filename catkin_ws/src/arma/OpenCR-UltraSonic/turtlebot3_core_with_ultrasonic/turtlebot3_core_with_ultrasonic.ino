...
void updateUltrasonicDist(){
  ...
  if(distance >= 200 || distance <= 0){
    ...
    ultrasonic_distance.data = -1;
  }
  else{
    //Serial.print(distance);
    //Serial.println(" cm");
    ultrasonic_distance.data = distance;
  }

  //publish the data
  ultrasonic_dist_pub.publish(&ultrasonic_distance);
